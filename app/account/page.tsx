              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                <div className="relative shrink-0">
                  <div className="w-24 h-24 lg:w-28 lg:h-28 rounded-full border-4 border-[#8A7043] overflow-hidden bg-[#F0EBE1] shadow-lg">
                    <img src="/images/person.jpg" alt="Eleanor Harrington" className="w-full h-full object-cover" />
                  </div>
                  <button className="absolute bottom-1 right-1 bg-[#8A7043] text-white p-2 rounded-full border-2 border-[#F9F6F0] shadow-sm hover:scale-110 transition-transform">
                    <Edit2 size={14} />
                  </button>
                </div>
                
                <div className="flex flex-col items-center sm:items-start pt-2">
                  <h2 className="font-heading text-2xl text-[#0E332E] mb-2">Eleanor Harrington</h2>
                  ...
                  <button className="px-6 py-2 border border-[#8A7043] text-[#8A7043] text-[9px] font-bold tracking-widest uppercase hover:bg-[#8A7043] hover:text-white transition-colors">
                    Edit Profile
                  </button>
                </div>
              </div>
          ...
          <FadeInSection delay={300}>
            <div className="bg-white border border-[#8A7043]/30 rounded-xl p-6 shadow-sm h-full flex flex-col">
              <div className="flex justify-between items-end border-b border-[#0E332E]/10 pb-3 mb-4">
                ...
                <span className="text-[9px] font-bold tracking-[0.15em] text-[#8A7043] uppercase cursor-pointer hover:underline">View All</span>
              </div>
          ...
          <FadeInSection delay={400}>
            <div className="bg-white border border-[#8A7043]/30 rounded-xl p-6 shadow-sm flex flex-col">
              <div className="flex justify-between items-end border-b border-[#0E332E]/10 pb-3 mb-4">
                ...
                <span className="text-[9px] font-bold tracking-[0.15em] text-[#8A7043] uppercase cursor-pointer hover:underline">Book New</span>
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="border border-[#0E332E]/10 p-4 flex flex-col md:flex-row justify-between items-center gap-4 rounded-lg bg-[#F9F6F0]/30">
                  ...
                  <div className="flex justify-center items-center gap-4 w-full md:w-auto">
                    <button className="px-5 py-2 border border-[#8A7043] text-[#8A7043] text-[9px] font-bold tracking-widest uppercase hover:bg-[#8A7043] hover:text-white transition-colors rounded">
                      Reschedule
                    </button>
                  </div>
                </div>
                ...
                <div className="border border-[#0E332E]/10 p-4 flex flex-col md:flex-row justify-between items-center gap-4 rounded-lg bg-[#F9F6F0]/30">
                  ...
                  <div className="flex justify-center items-center gap-4 w-full md:w-auto">
                    <button className="px-5 py-2 bg-[#8A7043] text-white text-[9px] font-bold tracking-widest uppercase hover:bg-[#0E332E] transition-colors rounded">
                      Rebook
                    </button>
                  </div>
                </div>
